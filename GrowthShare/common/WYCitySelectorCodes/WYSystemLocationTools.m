...
@interface WYSystemLocationTools ()<NSCopying, NSMutableCopying, CLLocationManagerDelegate>
...
@implementation WYSystemLocationTools


#pragma mark - 单例

static WYSystemLocationTools *wySystemLocationTools = nil;

+ (instancetype)sharedWYSystemLocationTools {
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        wySystemLocationTools = [[WYSystemLocationTools alloc] init];
    });
    
    return wySystemLocationTools;
}

+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    
    @synchronized(wySystemLocationTools) {
        
        if (!wySystemLocationTools) {
            
            wySystemLocationTools = [super allocWithZone:zone];
        }
