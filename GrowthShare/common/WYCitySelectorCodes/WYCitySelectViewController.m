...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight - GSNAVBAR_HEIGHT) style:UITableViewStylePlain];
...
- (WYSearchResultView *)searchResultView {
    ...
    if (!_searchResultView) {
        ...
        _searchResultView = [[WYSearchResultView alloc] initWithFrame:CGRectMake(0, 44, kScreenWidth, kScreenHeight - GSNAVBAR_HEIGHT - 44)];
