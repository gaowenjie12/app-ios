...
@protocol WYSystemLocationToolsDelegate <NSObject>
...
@interface WYSystemLocationTools : NSObject

@property (assign, nonatomic) id<WYSystemLocationToolsDelegate> delegate;
