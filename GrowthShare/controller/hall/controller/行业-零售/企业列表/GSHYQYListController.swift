...
class GSHYQYListController: GSBaseController {
    private  lazy var tableView: UITableView = {
        let tableView = UITableView(frame: .zero, style: .plain)
        tableView.delegate = self
        tableView.dataSource = self
        tableView.separatorStyle = .none
        tableView.register(GSHYQYListCell.self, forCellReuseIdentifier: "GSHYQYListCell")
...
extension GSHYQYListController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "GSHYQYListCell", for: indexPath) as! GSHYQYListCell
        return cell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let jiaZhiCP = GSCompanyJJController.init()
        jiaZhiCP.title = "企业简介"
