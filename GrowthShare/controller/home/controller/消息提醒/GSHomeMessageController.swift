...
class GSHomeMessageController: GSBaseController {
    private  lazy var tableView: UITableView = {
        let tableView = UITableView(frame: .zero, style: .plain)
        tableView.delegate = self
        tableView.dataSource = self
        tableView.separatorStyle = .none
        tableView.register(GSHomeMessageCell.self, forCellReuseIdentifier: "GSHomeMessageCell")
...
extension GSHomeMessageController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "GSHomeMessageCell", for: indexPath) as! GSHomeMessageCell
        return cell
